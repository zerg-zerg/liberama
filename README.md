...
Доработки для браузерной читалки:
- Добавлена страница со списком загруженных книг в другом дизайне
- Страница сделана дефолтной при входе в читалку (TODO: Сделать опцию для этого)
- Поменял иконку страницы загрузки файла
- Добавлен Docker file&docker-compose
- TODO: добавить контейнер с calibre в компоуз и ходить в него
